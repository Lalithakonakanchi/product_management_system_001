        ...
        <div className="content-grid">
          ...
          <div className="card tagline-card">
            <div className="tagline-content">
              <h2>Telusko Trac: The Ultimate Product Tracker</h2>
              <p>
                Effortlessly manage your product inventory. Add, edit, and track
                your products with a simple and intuitive interface. Stay
                organized and in control of your stock.
              </p>
            </div>
          </div>
